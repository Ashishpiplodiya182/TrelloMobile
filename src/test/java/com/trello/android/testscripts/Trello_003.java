 ...
 * 
 * Name:Trello_003
 * Description: Verify that whether user is able to Re-open the board after closing the board.
 * 
 * @author Ashish Piplodiya , Gaurav S.
 *
 */
public class Trello_003 extends BaseTest
{
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from TrelloData where SlNo ='3'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class, description = "Description: Verify that whether user is able to Re-open the board after closing the board")
	public void tc_Trello_003(String SlNo , String	boardName , String	listName , String	listName2 , String	listName3	, String card1	 , String card2	 , String itemName	 , String updatedBoardName	, String updatedListName	, String updatedcardName ,String copyListName , String position) throws InterruptedException
	{
		...
		/* Click on Menu Icon */
		pages.home_Page.clkMenuIcon();

		/* Click on Home Link */
		pages.home_Page.clkHomeLink();
		
		/* Click on Menu Icon */
		pages.home_Page.clkMenuIcon();
		
		/* Click on Workspace link */
		pages.home_Page.clkWorkSpaceLink(properties.getProperty("workspaceName"));

		/* Click on Board under Closed Boards Section */
		pages.home_Page.clkBoardUnderClosedBoards(boardName);

		/* Click on Re-open Board */
		pages.boardDashboard_page.clkReOpenBoards(boardName);

		/* Click on List Action Under Boards */
		pages.boardDashboard_page.clkListActionsBoards();
