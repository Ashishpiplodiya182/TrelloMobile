 ...
 * 
 * Name:Trello_004
 * Description:Verify that whether user is able to move the card after Editing List name and Card name.
 * 
 * @author Ashish Piplodiya , Gaurav S.
 *
 */
public class Trello_004 extends BaseTest
{
	
	@DataProviderFileRowFilter(file = "./src/main/resources/data/Data.xlsx", sql = "Select * from TrelloData where SlNo ='4'")
	@Test(dataProvider = "data1", dataProviderClass = DataProviderFactory.class, description = "Description:Verify that whether user is able to move the card after Editing List name and Card name")
	public void tc_Trello_004(String SlNo , String	boardName , String	listName , String	listName2 , String	listName3	, String card1	 , String card2	 , String itemName	 , String updatedBoardName	, String updatedListName	, String updatedcardName ,String copyListName , String position) throws InterruptedException
	{
		...
		/* Set Edit list Name */
		pages.boardDashboard_page.setEditListNameTa(listName, updatedListName);

		/* Click on Card Name */
		pages.boardDashboard_page.clkCardName(card1);

		/* Click Card Name Link */
		pages.cardModification_page.clkCardNameLink(card1, updatedcardName);

		/* Click on Confirm Tickmark*/
		pages.cardModification_page.clkConfirmTickMarkForEditCardName();
		...
		pages.boardDashboard_page.dragAndDropElement(updatedcardName, listName2);
		...
		/* Drag and Drop Card to another List */
		pages.boardDashboard_page.dragAndDropElement(updatedcardName, listName3);
